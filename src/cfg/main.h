...
typedef struct __attribute__((__packed__)) {
    ...
    uint8_t gndmanual:1 = 1;                    // Разрешение на ручную корректировку нуля
    uint8_t :0;
    uint8_t gndauto:1 = 1;                      // Разрешение на автокорректировку нуля
    uint8_t _gnd:1;                             // резерв
    uint8_t altmeter:1 = 1;                     // отображение высоты в метрах (на странице высотомера)
    uint8_t :0;
