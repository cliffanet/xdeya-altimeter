...
`Себестоимость устройства:` `v.0.3` = 2500р, `v.0.4` = 3000р - это только детали и корпус, без учёта сборки и обслуживания, т.к. делаю сам. Стоимость продолжает увеличиваться при нынешней инфляции и росте курса доллара.
